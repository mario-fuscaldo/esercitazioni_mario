...
int Leggi(struct LettScritt * ls) {
	 ...
	 * altrimenti non potrebbero leggere contemporaneamente visto che
	 * alla wait se ne può segnalare solo uno
	 */
////////////////////////////////////////////////////////////////////
	signal_condition( &(ls->m), VARCOND_LETTORI );				//parte che cambia 
////////////////////////////////////////////////////////////////////
	leave_monitor( &(ls->m) );
