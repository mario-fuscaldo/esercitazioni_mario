...
int main() {
	...
	int id_shm = shmget( chiave_shm, sizeof(struct ProdCons), IPC_CREAT|0664); //nella size c'è anche il monitor
	...
	init_monitor( &(pc->m), 2 );	//prende il posto di semget

	pc->numero_liberi = DIM;	//come i semafori
