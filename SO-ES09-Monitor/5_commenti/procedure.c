...
int Leggi(struct LettScritt * ls) {
	...
	while( ls->numero_scrittori > 0 ) {
        ...
        // o poi, (perché ci sarà una signal all)
		//quindi posso lasciare il monitor senza segnalare nessun lettore
...
/*
* per starvation soli scrittori
* non si fa controllo su se sono ultimo o no 
* si mette in starvation e basta
*
*/
